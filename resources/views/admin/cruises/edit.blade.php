                ...
                <div class="col-lg-10 col-xl-8">
                    ...
                    <div class="page-header">
                        <div class="header-content">
                            ...
                            <div class="header-text">
                                <h1>Modifica Crociera</h1>
                                <p>Modifica i dettagli della crociera: {{ $cruise->ship }} - {{ $cruise->cruise }}</p>
                            </div>
                        </div>
                        <div class="header-actions">
                            <a href="{{ route('cruises.show', $cruise->id) }}" class="btn btn-action" style="color: white">
                    ...
                    <div class="form-card">
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form id="cruiseForm" method="POST" action="{{ route('cruises.update', $cruise->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-section">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="ship" name="ship" 
                                                       value="{{ old('ship', $cruise->ship) }}" required
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="line" name="line" required>
                                                    ...
                                                    <option value="MSC Cruises" {{ old('line', $cruise->line) == 'MSC Cruises' ? 'selected' : '' }}>MSC Cruises</option>
                                                    <option value="Costa Crociere" {{ old('line', $cruise->line) == 'Costa Crociere' ? 'selected' : '' }}>Costa Crociere</option>
                                                    <option value="Royal Caribbean" {{ old('line', $cruise->line) == 'Royal Caribbean' ? 'selected' : '' }}>Royal Caribbean</option>
                                                    <option value="Norwegian Cruise Line" {{ old('line', $cruise->line) == 'Norwegian Cruise Line' ? 'selected' : '' }}>Norwegian Cruise Line</option>
                                                    <option value="Celebrity Cruises" {{ old('line', $cruise->line) == 'Celebrity Cruises' ? 'selected' : '' }}>Celebrity Cruises</option>
                                                    <option value="Princess Cruises" {{ old('line', $cruise->line) == 'Princess Cruises' ? 'selected' : '' }}>Princess Cruises</option>
                                                    <option value="Holland America Line" {{ old('line', $cruise->line) == 'Holland America Line' ? 'selected' : '' }}>Holland America Line</option>
                                                    <option value="Altra" {{ old('line', $cruise->line) == 'Altra' ? 'selected' : '' }}>Altra</option>
                                                </select>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cruise" name="cruise" 
                                               value="{{ old('cruise', $cruise->cruise) }}" required
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="duration" name="duration" 
                                                       value="{{ old('duration', $cruise->duration) }}" min="1" max="365"
                                                       placeholder="7">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="night" name="night" 
                                                       value="{{ old('night', $cruise->night) }}" min="1" max="365"
                                                       placeholder="6">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="partenza" name="partenza" 
                                                       value="{{ old('partenza', $cruise->partenza ? $cruise->partenza->format('Y-m-d') : '') }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="arrivo" name="arrivo" 
                                                       value="{{ old('arrivo', $cruise->arrivo ? $cruise->arrivo->format('Y-m-d') : '') }}">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="interior" name="interior" 
                                                       value="{{ old('interior', $cruise->interior) }}" min="0" step="0.01"
                                                       placeholder="0.00">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="oceanview" name="oceanview" 
                                                       value="{{ old('oceanview', $cruise->oceanview) }}" min="0" step="0.01"
                                                       placeholder="0.00">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="balcony" name="balcony" 
                                                       value="{{ old('balcony', $cruise->balcony) }}" min="0" step="0.01"
                                                       placeholder="0.00">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="minisuite" name="minisuite" 
                                                       value="{{ old('minisuite', $cruise->minisuite) }}" min="0" step="0.01"
                                                       placeholder="0.00">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="suite" name="suite" 
                                                       value="{{ old('suite', $cruise->suite) }}" min="0" step="0.01"
                                                       placeholder="0.00">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="details" name="details" rows="4"
                                                  placeholder="Inserisci dettagli aggiuntivi, servizi inclusi, note particolari...">{{ old('details', $cruise->details) }}</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    <h5 class="section-title">
                                        <i class="fas fa-clock me-2"></i>Informazioni Sistema
                                    </h5>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{ route('cruises.show', $cruise->id) }}" class="btn btn-outline-info">
                                        <i class="fas fa-eye me-2"></i>Visualizza
                                    </a>
