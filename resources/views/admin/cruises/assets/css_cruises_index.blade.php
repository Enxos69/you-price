<style>
    /* ✅ CSS OTTIMIZZATO PER PERFORMANCE E GROSSE MOLI DI DATI */
    ...
    * {
    ...
    /* ================== DARK MODE RIMOSSO - SOLO MODALITÀ CHIARA ================== */
    /* Tutte le regole dark mode sono state rimosse per mantenere sempre l'aspetto chiaro */
    ...
    @media (prefers-reduced-motion: reduce) {
        ...
        .loading-spinner {
            animation: none !important;
            border: 3px solid var(--youPrice-primary) !important;
        }
    }
    ...
    * {
    ...
    /* Prefetch DNS per possibili risorse future */
    .dns-prefetch::before {
        content: '';
        display: none;
    }
    ...
    /* Safari iOS fix per sticky header */
