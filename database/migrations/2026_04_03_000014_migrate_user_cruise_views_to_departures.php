...
return new class extends Migration
{
    ...
    {
        Schema::table('user_cruise_views', function (Blueprint $table) {
            $table->dropForeign(['cruise_id']);
            $table->dropIndex(['cruise_id', 'view_count']);
            ...
            $table->index(['departure_id', 'view_count']);
    ...
    public function down(): void
    {
        Schema::table('user_cruise_views', function (Blueprint $table) {
            ...
            $table->dropIndex(['departure_id', 'view_count']);
